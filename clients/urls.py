...
urlpatterns = [
    ...
    path('list/', login_required(ListClient.as_view()), name='list_client'),
    ...
    path('doesnt_found/', login_required(TemplateView.as_view(template_name='clients/client_doesnt_found.html')),
         name='doesnt_found_client')  # noqa: E501
]
